...
function ListChapProcess(b, f, h, p, k) {
	$("#list-chapter .pagination").replaceWith(p);
	...
	window.history.pushState({
		...
		truyen_ascii: f,
		page: h
	}, "Truy\u1ec7n " + b + " - Trang " + h, "/" + f + "/trang-" + h + "/#list-chapter");
	document.title = "Truy\u1ec7n " + b + " - Trang " + h;
	ga("send", "pageview", {
		page: "/" + f + "/trang-" + h + "/",
		title: "Truy\u1ec7n " + b + " - Trang " + h + " - Ajax"
	})
}

function FormError(b, f) {
	f ? $("#" + f + " .single-page-status").removeClass("alert-success hide").addClass("alert-danger").html(b) : ($(".single-page-status").removeClass("alert-success hide").addClass("alert-danger").html(b), $("html, body").animate({
		scrollTop: $(".single-page-status").offset().top
	}, "slow"))
}

function FormSuccess(b, f) {
	f ? $("#" + f + " .single-page-status").removeClass("alert-danger hide").addClass("alert-success").html(b) : ($(".single-page-status").removeClass("alert-danger hide").addClass("alert-success").html(b), $("html, body").animate({
		scrollTop: $(".single-page-status").offset().top
	}, "slow"))
}
...
function load_comment(b, f, h) {
	h = "light";
	$("#" + b).html('<div class="fb-comments" data-href="http://truyenfull.vn/' + f + '/" data-width="100%" width="100%" data-numposts="5" data-colorscheme="' + h + '"></div>');
	if ("undefined" !== typeof FB) FB.XFBML.parse(document.getElementById(b));
	else var p = setInterval(function () {
		"undefined" !== typeof FB && (FB.XFBML.parse(document.getElementById(b)), clearInterval(p))
	}, 100)
}

function update_views(b, f) {
	$.post("/ajax.php", {
		type: "update_views",
		tid: b,
		add: f,
...
$(document).ready(function () {
	if ($("body").is("#body_home")) {
		var b = $("#intro-index").width(),
			f = $("#intro-index").height(),
			h = $("#intro-index").offset().top,
			p = $("#intro-index").offset().left + parseInt($("#intro-index").css("padding-left"));
		$(".index-intro .item").each(function () {
			var a = $(this),
				...
				g = $(a).offset().top;
			a = $(a).offset().left;
			a >= p && g >= h && a + d <= p + b && g + e <= h + f + 1 && (c.attr("src", c.attr("lazysrc")), c.attr("lazysrc", ""))
		})
	}
	...
	var k = $("#truyen-ascii").val(),
		r = $("#ten-truyen").val(),
		l = $("#truyen-id").val();
	$("body").is("#body_truyen") && update_views(l, "truyen");
	...
	if (l) {
		"/" != window.location.pathname && function (a, c, d) {
			var e = a.getElementsByTagName(c)[0];
			a.getElementById(d) || (a = a.createElement(c), a.id = d, a.src = "https://connect.facebook.net/vi_VN/all.js#version=v3.1&appId=333184773543272", e.parentNode.insertBefore(a, e))
		}(document, "script", "facebook-jssdk");
		var z = $("#truyen-comment").val()
	}
	...
	$("#truyen-background").on("change", function () {
		...
		r ? "hatsan" == a ? ($("body").css({
			...
			"background-image": "url('//static.8cache.com/img/bg_book_op.png')",
			"background-repeat": "repeat"
		}).removeClass("dark-theme"), n = "light") : "#232323" == a ? ($("body").css({
			"background-color": a,
			"background-image": "url('//static.8cache.com/img/bg_dark.gif')",
			"background-repeat": "repeat"
	...
	k && setTimeout(function () {
		load_comment("fb-comment-story", z, n)
	}, 2E3);
	if (r) {
		m = $.cookie("font-cookie");
		var A = $.cookie("size-cookie"),
			w = $.cookie("lineheight-cookie"),
			C = $.cookie("fluid-switch-cookie"),
			D = $.cookie("onebreak-switch-cookie"),
			x = $("#chapter-bnum").val(),
			y = $("#chapter-num").val();
		1 == $("#chapter-sac").val() && ga("send", "event", "truyensac");
		m ? $("#font-chu").val(m) : $.browser.mobile && $("#font-chu").val("Arial, sans-serif");
		A ? $("#size-chu").val(A) : $.browser.mobile || $("#size-chu").val("22px");
		w && "180%" != w ? $("#line-height").val(w) : $("#line-height").val("180%");
		...
		$(document).keydown(function (a) {
			!1 !== $("input[type='text'], input[type='search']").is(":focus") || a.ctrlKey || (37 == a.which || 65 == a.which ? $("#prev_chap")[0].click() : 39 == a.which || 68 == a.which ? $("#next_chap")[0].click() : 83 == a.which ? (a = $(window).scrollTop(), $(window).scrollTop(a + 37)) : 87 == a.which && (a = $(window).scrollTop(), $(window).scrollTop(a -
				37)))
		});
		$(".chapter-nav").on("click", "button.chapter_jump", function () {
			...
			$.get("/ajax.php", {
				...
				var c = "";
				x && (c = "quyen-" + x + "-");
				a = a.replace(new RegExp(c + "chuong-" + y + '">', "g"), c + "chuong-" + y + '" selected>');
		...
		$(".chapter-nav").on("click", "button#chapter_comment", function () {
			load_comment("fb-comment-chapter", z, n)
		});
		m = $(".truyen-title").text();
		$.post("/ajax.php", {
	...
	$("#search-input").keyup(function () {
		...
		clearTimeout(u);
		a = $(this).val();
		0 == a.length ? $(".list-search-res").html("").addClass("hide") : 3 <= a.length && ($(".list-search-res").html('<img src="//static.8cache.com/img/loading-search.gif" alt="loading">').removeClass("hide"), u = setTimeout(function () {
			quick_search(a)
		}, 500))
	});
	$("#search-input").bind("paste", function () {
		...
		setTimeout(function () {
			var c = $(a).val();
			0 == c.length ? $(".list-search-res").html("").addClass("hide") : 3 <= c.length && ($(".list-search-res").html('<img src="//static.8cache.com/img/loading-search.gif" alt="loading">').removeClass("hide"), u = setTimeout(function () {
				quick_search(c)
			}, 500))
		}, 0)
	});
	...
	$("#list-chapter").on("submit", "#page_jump", function (a) {
		a.preventDefault();
		var c = $("#page_jump").find("button[type='submit']"),
			d = $("h1").text();
		a = $("#total-page").val();
		var e = parseInt($("input[name='page']").val(), 10);
		e > a && (e = a);
		isNumber(e) && 0 === e % 1 && (c.css({
			cursor: "default",
			"pointer-events": "none",
			opacity: "0.6"
		}), $.get("/ajax.php", {
			...
			ListChapProcess(d, k, e, g.page_list, g.chap_list);
			c.css({
				cursor: "pointer",
				"pointer-events": "auto",
				opacity: "1"
	...
	$("#list-chapter").on("click", ".pagination li a", function (a) {
		...
		if ("javascript:void(0)" != d) {
			...
			var e = $("h1").text();
			a = $("#total-page").val();
			if (d == "https://truyenfull.vn/" + k + "/#list-chapter") g = 1;
			else {
				var g = d.match(/(\d+)(?!.*\d)/);
				g = g[1]
			}
			$.get("/ajax.php", {
				...
				ListChapProcess(e, k, g, t.page_list, t.chap_list);
				c.css({
					cursor: "pointer",
					"pointer-events": "auto",
					opacity: "1"
	...
	if ($("#body_home").length) {
		...
		$("#hot-select").on("change", function () {
			...
			$.get("/ajax.php", {
				...
				$(".index-intro").hide().html(c).fadeIn();
				clearTimeout(q);
				q = setTimeout(v, 6E4)
			})
		});
	...
	$("#contact-form").submit(function (a) {
		...
		var c = $("#contact-email").val(),
			d = $("#contact-subject").val(),
			e = $("#contact-message").val(),
			g = $("#contact-secure").val();
		if (!a || !d || !e) return FormError("B\u1ea1n vui l\u00f2ng \u0111i\u1ec1n \u0111\u1ee7 th\u00f4ng tin li\u00ean h\u1ec7.", "contact-container"), !1;
		...
		$.post("/ajax.php", {
			...
			"success" == t.status ? (FormSuccess("B\u1ea1n \u0111\u00e3 g\u1eedi n\u1ed9i dung li\u00ean h\u1ec7 th\u00e0nh c\u00f4ng! / Your message was sent successfully!", "contact-container"), $("#contact-form").trigger("reset"), $("#contact-secure").val(t.token)) : FormError("G\u1eedi n\u1ed9i dung li\u00ean h\u1ec7 th\u1ea5t b\u1ea1i, b\u1ea1n vui l\u00f2ng th\u1eed l\u1ea1i sau ho\u1eb7c g\u1eedi email tr\u1ef1c ti\u1ebfp \u0111\u1ebfn contact@truyenfull.vn / Error, please try again later or send email directly to contact@truyenfull.vn", "contact-container")
		})
	});
	$(".pagination-container").on("submit", "#page_jump", function (a) {
		a.preventDefault();
		a = $("input[name='page_type']").val();
		var c = $("input[name='page']").val(),
			d = $("input[name='filter']").val();
		a ? isNumber(c) && 0 === c % 1 && (window.location.href = "https://truyenfull.vn/" + a + "/" + k + d + "/trang-" + c + "/") : isNumber(c) && 0 === c % 1 && (window.location.href = "https://truyenfull.vn/" + k + "/trang-" + c + "/#list-chapter")
	});
	$("#chapter-nav-top, #chapter-nav-bot").on("change", ".chapter_jump", function () {
		$("option:selected", this);
		var a = this.value;
		a && r && (window.location.href = "https://truyenfull.vn/" + r + "/" + a + "/")
	});
			...
			$("div.lazyimg").each(function () {
				if ($(this).is(":onScreen")) {
					var a = $.browser.mobile ? $(this).data("image") : $(this).data("desk-image"),
						c = $(this).data("classname"),
						d = $(this).data("alt");
					a = c ? '<img src="' + a + '" class="' + c + '" alt="' + d + '">' : '<img src="' + a + '" alt="' + d + '">';
					$(this).replaceWith(a)
				}
			})
		};
...
ga('send', 'pageview');;
var outbrain_check, chaptersac = $("#chapter-sac").val();

function nextNode_remove(b) {
	var a = $("div#" + b)[0].nextSibling;
	a && 3 != a.nodeType && $("div#" + b).next("br").remove();
...
function load_qc_outbrain(b, a, c) {
	postscribe(b, '<div class="OUTBRAIN" data-src="' + a + "/" + c + '/" data-widget-id="GS_1" data-ob-template="Truyenfull.vn"></div> <script type="text/javascript" async="async" src="//widgets.outbrain.com/outbrain.js">\x3c/script>')
}
...
function backupads(b) {
	...
	$(b).html("");
	"#ads-320-100-backup-4" == b && load_qc_outbrain(b, "https://truyenfull.vn", a)
}

function ads_load() {
	$("#ten-truyen").val();
	$("#truyen-ascii").val();
	var b = $(".chapter-c").html().length,
		a = $(".chapter-c").find("p, br, img, table"),
		c = a.length,
		f = parseInt(c / 8),
		e = parseInt(c / 5 * 2),
		d = parseInt(c / 11 * 7);
	long_botLength = parseInt(c / 10 * 8);
	c = randomso(1, 4);
	postscribe("#ads-chapter-pc-top", '<script src="//static.sourcetobin.com/jspartner/b158.js">\x3c/script>');
	$.browser.mobile ? (a.eq(e).after('<div class="ads-responsive incontent-ad ad-bghighlight mgid-iab mgid-iab-mobile" id="ads-chapter-top" align="center" style="height:645px"></div>'), postscribe("#ads-chapter-top", '<div class="adlabel"><span>Advertisement / Qu\u1ea3ng c\u00e1o</span></div><script src="//static.sourcetobin.com/jspartner/b148.js">\x3c/script>')) : (a.eq(e).after('<div class="ads-responsive incontent-ad ad-bghighlight mgid-iab mgid-iab-mobile" id="ads-chapter-top"></div>'), $("#ads-chapter-top").html('<div id="M182108ScriptRootC863748"></div><script src="https://jsc.mgid.com/t/r/truyenfull.vn.863748.js" async>\x3c/script>'), nextNode_remove("ads-chapter-top"));
	1500 <= b && (a.eq(f).after('<div class="ads-responsive incontent-ad ad-bghighlight mgid-iab mgid-iab-mobile" id="ads-chapter-longtop"></div>'), 2 == c ? postscribe("#ads-chapter-longtop", '<div id="M182108ScriptRootC863753"></div><script src="https://jsc.mgid.com/t/r/truyenfull.vn.863753.js" async>\x3c/script>') : 1 == rotate_cookie_func("longtop_rorate_cookie") ? postscribe("#ads-chapter-longtop", '<div id="M553328ScriptRootC966258"></div><script src="https://jsc.adskeeper.co.uk/t/r/truyenfull.vn.966258.js" async>\x3c/script>') : postscribe("#ads-chapter-longtop", '<div id="M553328ScriptRootC963288"></div><script src="https://jsc.adskeeper.co.uk/t/r/truyenfull.vn.963288.js" async>\x3c/script>'), $.browser.mobile ? 1 == rotate_cookie_func("middle_rorate_cookie") ? (a.eq(d).after('<div class="ads-responsive incontent-ad ad-bghighlight mgid-iab mgid-iab-mobile" id="ads-chapter-middle"></div>'), postscribe("#ads-chapter-middle", '<div id="M553328ScriptRootC977836"></div><script src="https://jsc.adskeeper.co.uk/t/r/truyenfull.vn.977836.js" async>\x3c/script>')) : a.eq(d).after('<div id="ads-chapter-middle"></div>') : (a.eq(d).after('<div class="ads-responsive incontent-ad" id="ads-chapter-middle"></div>'), postscribe("#ads-chapter-middle", "<div id = 'vdo_ai_div'></div><script>(function(v,d,o,ai){ai=d.createElement('script');ai.defer=true;ai.async=true;ai.src=v.location.protocol+o;d.head.appendChild(ai);})(window, document, '//a.vdo.ai/core/truyenfull/vdo.ai.js?vdo=34');\x3c/script>")), nextNode_remove("ads-chapter-middle"));
	5E3 <= b && ($.browser.mobile ? (a.eq(long_botLength).after('<div class="ads-responsive incontent-ad ad-bghighlight mgid-iab mgid-iab-mobile" id="ads-chapter-longbot"></div>'), postscribe("#ads-chapter-longbot", '<div id="M553328ScriptRootC977837"></div><script src="https://jsc.adskeeper.co.uk/t/r/truyenfull.vn.977837.js" async>\x3c/script>')) : (a.eq(long_botLength).after('<div class="ads-responsive incontent-ad ad-bghighlight mgid-iab mgid-iab-desktop" id="ads-chapter-longbot"></div>'), postscribe("#ads-chapter-longbot", '<div id="M182108ScriptRootC841578"></div><script src="https://jsc.mgid.com/t/r/truyenfull.vn.841578.js" async>\x3c/script>')))
}
$(document).ready(function () {
	var b = $("#ten-truyen").val();
	$("#truyen-ascii").val();
	b && ($.browser.mobile ? (ads_load(), $("#chapter-end-bot").before('<div class="text-center ads-holder ads-taboola"><div id="ads-chapter-bottom"></div></div>')) : (ads_load(), $("#chapter-end-bot").before('<div class="text-center ads-holder ads-taboola ads-taboola-desktop"><div id="ads-chapter-bottom"></div></div>')), load_qc_outbrain("#ads-chapter-bottom", "https://truyenfull.vn", b))
});
